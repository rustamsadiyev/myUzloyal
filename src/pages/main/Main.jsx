...
const Main = () => {
  ...
  return (
    <div className=" mt-10 overflow-x-hidden pb-10">
      <div className="px-4 md:px-[11%]">
        <swiper-container className="" ref={swiperRef}>
          {services &&
            services.map((e, idx) => (
              <swiper-slide key={idx}>
                <div
                  onClick={() => {
                    window.location.href = `/service/${e.id}`;
                  }}
                ...
                <div key={idx} className="rounded-md ">
                  ...
                  <div className="p-4">
                    ...
                    <a
                      ...
                      href={`/blog-single-left-sidebar/${blog.id}`}
                    >
                      Koproq bilish
                    </a>
                  </div>
