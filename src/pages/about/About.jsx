...
const help_content = [
  ...
  { text: 'lizing nizolari', img: help6 },
]

const work_content = [
  { text: 'Criminal Law', img: help1 },
  { text: 'Family Law', img: help2 },
  { text: 'Business Law', img: help3 },
  { text: 'Divorce Law', img: help4 },
  { text: 'Real Estate', img: help5 },
  { text: 'Family Law', img: help6 },
]
      ...
      <div className={css.help}>
        ...
        <div className={css.help_content}>
          {help_content.map((item => (
            <Link className={css.help_content__link}>
        ...
        <div className={css.work_content}>
          {
            work_content.map((item => (
              <div className={css.work_content__link}>
                <img src={item.img} alt="" />
                <Link to="/"><span>{item.text}</span></Link>
                <p />
              </div>
            )))
          }
